...
class _Config:
    ...
    ASSUMED_ROUND_DURATION = ASSUMED_ROUND_DURATION
    KP = KP
    ...
    STANCE_CONFIDENCE_FRAMES = STANCE_CONFIDENCE_FRAMES
    STANCE_FOOT_DIST_RATIO = STANCE_FOOT_DIST_RATIO
    HISTORY_LENGTH = HISTORY_LENGTH
    FIGHTER_1_COLOR = FIGHTER_1_COLOR
    FIGHTER_2_COLOR = FIGHTER_2_COLOR
    TRAIL_LENGTH = TRAIL_LENGTH
    EVENT_POPUP_FRAMES = EVENT_POPUP_FRAMES
